...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202209270901-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Tuesday, Sep 27, 2022 09:01 EDT
# @@File             :  install.sh
# @@Description      :
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/transmission"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="transmission"
INSTDIR="$HOME/.local/share/dockermgr/transmission"
APPDIR="$HOME/.local/share/srv/docker/transmission"
DATADIR="$HOME/.local/share/srv/docker/transmission/files"
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Setup variables
SERVER_IP="${DOCKER_HOST_IP:-127.0.0.1}"
...
SERVER_PORT_EXT="${SERVER_PORT_EXT:-9091}"
SERVER_PORT_INT="${SERVER_PORT_INT:-9091}"
SERVER_PORT_ADMIN_EXT="${SERVER_PORT_ADMIN_EXT:-51413}"
SERVER_PORT_ADMIN_INT="${SERVER_PORT_ADMIN_INT:-51413}"
...
HUB_URL="casjaysdevdocker/transmission"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
